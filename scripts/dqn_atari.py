...
from torchrl.data import LazyMemmapStorage, TensorDictReplayBuffer, ListStorage, TensorStorage
...
@hydra.main(config_path="../cfg", config_name="config_atari", version_base="1.1")
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    with tempfile.TemporaryDirectory() as tempdir:
        ...
        num_updates = (
            cfg.loss.num_updates
            if cfg.loss.num_updates > 0
            else cfg.collector.frames_per_batch // 2
        )
        ...
        n_timesteps = 0
        for rollout_idx, data in enumerate(collector):
            log_info = {}
