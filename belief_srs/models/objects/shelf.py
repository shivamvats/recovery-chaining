...
class Shelf(CompositeObject):
    ...
    def __init__(
        ...
        # super().__init__(joints=None, **self._get_geom_attrs())
        super().__init__(joints=None, **self._get_geom_attrs())
    ...
    @property
    def dims(self):
        bin_dims = self.bin_size
        shelf_dims = np.array([bin_dims[0], bin_dims[2], bin_dims[1]])
        return shelf_dims
